...
export class FavoritesService {
  ...
  async findAll() {
    ...
    favorites.albums = await this.albumRepository.findBy({ id: In(favorites.albums) });
    favorites.artists = await this.artistRepository.findBy({ id: In(favorites.artists) });
    favorites.tracks = await this.trackRepository.findBy({ id: In(favorites.tracks) });
